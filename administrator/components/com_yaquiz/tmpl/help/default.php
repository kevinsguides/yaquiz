...
<a href="https://kevinsguides.com/guides/webdev/joomla4/free-extensions/yaq" target="_blank" class="btn btn-info btn-lg"><?PHP echo Text::_('COM_YAQUIZ_DOCS_OFFICIAL'); ?></a>
<a href="https://github.com/kevinsguides/yaquiz/releases" target="_blank" class="btn btn-dark btn-lg"><?PHP echo Text::_('COM_YAQUIZ_RELEASES'); ?></a>
<hr/>
