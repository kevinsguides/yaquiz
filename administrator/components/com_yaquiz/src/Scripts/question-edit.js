...
document.addEventListener("DOMContentLoaded", function(event) {
    ...
    const toast = document.getElementById('yaquiz-toast');
    const toastMessage = document.getElementById('yaquiz-toast-message');
    ...
    document.getElementById('yaquiz-toast-close').addEventListener('click', function() {
        toast.classList.remove('show');
    });
