...
<form action="index.php?option=com_simplequiz&task=question.edit" method="post">
 ...
 ?>
    ...
    <hr/>
    <button class="btn btn-success" type="submit"><span class="icon-save"></span> Save</button>
    <a class="btn btn-danger" href="index.php?option=com_simplequiz&view=Questions">Close</a>
</form>
